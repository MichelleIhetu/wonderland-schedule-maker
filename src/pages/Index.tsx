      ...
      <div className="min-h-screen relative overflow-hidden" style={{ background: "hsl(300 50% 88%)" }}>
        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          ...
          <div className="flex-1 flex flex-col items-center justify-center gap-6 px-6 sm:px-12 relative w-full -translate-x-[10%] sm:-translate-x-[15%]">
            ...
            {/* Glass Start button - positioned right beneath base of clock handles */}
            <button
              onClick={handleStart}
              className="glass-pill px-12 sm:px-16 py-4 sm:py-5 rounded-full cursor-pointer transition-all hover:scale-105 active:scale-95 mt-20 sm:mt-24 md:mt-28 lg:mt-32"
            >
