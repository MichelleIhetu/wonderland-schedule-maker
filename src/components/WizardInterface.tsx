            ...
            {showSpeechBubble && (
              <motion.div
                ...
                className={`absolute -top-16 z-30 ${
                  scene === "stress"
                    ? "w-56 right-[60%]"
                    : scene === "energy"
                    ? "w-56 right-[-20%] sm:w-72 sm:right-[20%] md:w-80"
              ...
              >
                ...
                <div className="relative h-12 w-full">
                  <motion.div animate={{ y: [0, -3, 0] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0 }} className={`absolute top-0 w-4 h-4 bg-white border-2 rounded-full ${scene === "stress" ? "right-[30%]" : scene === "energy" ? "left-[30%] sm:right-[30%] sm:left-auto" : "right-[30%]"}`} style={{ borderColor: "hsl(280 40% 20%)" }} />
                  <motion.div animate={{ y: [0, -3, 0] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0.2 }} className={`absolute top-4 w-2.5 h-2.5 bg-white border-2 rounded-full ${scene === "stress" ? "right-[20%]" : scene === "energy" ? "left-[20%] sm:right-[20%] sm:left-auto" : "right-[20%]"}`} style={{ borderColor: "hsl(280 40% 20%)" }} />
                  <motion.div animate={{ y: [0, -3, 0] }} transition={{ duration: 1.5, repeat: Infinity, delay: 0.4 }} className={`absolute top-8 w-1.5 h-1.5 bg-white border-2 rounded-full ${scene === "stress" ? "right-[12%]" : scene === "energy" ? "left-[12%] sm:right-[12%] sm:left-auto" : "right-[12%]"}`} style={{ borderColor: "hsl(280 40% 20%)" }} />
                </div>
              </motion.div>
            )}
          </AnimatePresence>
